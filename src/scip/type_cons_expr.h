...
/** data on bounds on a subset of variables */
struct SCIP_ConsExpr_BndData
{
...
typedef struct SCIP_ConsExpr_BndData SCIP_CONSEXPR_BNDDATA;    /**< data on bounds on a subset of variables */
